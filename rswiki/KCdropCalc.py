        ...
        for drop in dropDict:
            if dropDict[drop]["dropRate"][0] == "Always":
                if len(dropDict[drop]["dropAmount"]) == 2:
                    newDict[drop]["dropAmount"] += randint(dropDict[drop]["dropAmount"][0],
                                                           dropDict[drop]["dropAmount"][1])
                else:
        ...
        for ndrop in newDict:
            if drops[drop] == newDict[ndrop]["itemName"]:
                if len(dropDict[ndrop]["dropAmount"]) == 2:
                    newDict[ndrop]["dropAmount"] += randint(dropDict[ndrop]["dropAmount"][0],
                                                            dropDict[ndrop]["dropAmount"][1])
                else:
...
if __name__ == '__main__':
    ...
    killcount = int(input("Input killcount: "))
    main(monster, killcount)
